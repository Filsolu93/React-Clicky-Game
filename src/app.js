...
class App extends Component {
    ...
    render() {
        return ( <div className = "App" >
            ...
            <h1 className = "App-title" > The Clickster < /h1> < p className = "App-intro" >
...
Score total = {
            ...
            status = {
                ...
                < p > Designed and built by filmon habtu.You can find the code < a href = "https://github.com/Filsolu93/React-Clicky-Game.git"
            target = "_blank"
